...
namespace alarm3d\comments;

use Yii;

/**
 * Class Comments module definition class
 * @package alarm3d\comments
 */
class Module extends \yii\base\Module
{
     ...
     * @var string
     */
    public $commentModelClass = 'alarm3d\comments\models\Comments';

    /**
     * @var string
     */
    public $commentRatingModelClass = 'alarm3d\comments\models\CommentsRating';

    /**
     * @inheritdoc
     */
    public $controllerNamespace = 'alarm3d\comments\controllers';
