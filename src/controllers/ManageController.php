...
namespace alarm3d\comments\controllers;

use Yii;
use yii\web\NotFoundHttpException;
use alarm3d\comments\Module as CommentsModule;

/**
 * Class ManageController for the `comments` module
 * @package alarm3d\comments\controllers
 */
class ManageController extends \yii\web\Controller
{
     ...
     * @var string
     */
    public $indexView = '@vendor/alarm3d/yii2-comments/src/views/manage/index';

    /**
     * @var string
     */
    public $updateView = '@vendor/alarm3d/yii2-comments/src/views/manage/update';

    /**
     * @var string
     */
    public $viewView = '@vendor/alarm3d/yii2-comments/src/views/manage/view';

    /**
     * @var string
     */
    public $searchModelClass = 'alarm3d\comments\models\CommentsSearch';
